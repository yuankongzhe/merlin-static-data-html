                ...
                <div className='row' >
                  ...
                  <div className='col-md-6 col-ms-12 d-flex align-items-center justify-content-center' >
                      <div className='row text-end'>
                        ...
                        截至03-04，目前场外MERL平均成交价为<br></br>
                        2.71 USDT（来自<a href="https://app.whales.market/" target="_blank" rel="noopener noreferrer">whales</a>平台）<br></br>
                        2.87 USDT（来自企鹅OTC群: 383301198）
                        </span>
                      </div>
                      <div className='row'>                     
                      </div>
